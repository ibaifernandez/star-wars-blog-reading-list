...
const VehicleConstructor = () => {
    ...
    if (vehicleProperties.length === 0) {
        return (
            <div className="h1 text-center my-5 w-75 mx-auto">
                Regrettably, Star Wars' DataBase wasn't able to handle this
                request!
            </div>
        );
    } else {
                    ...
                    <div className="row">
                        <div className="w-65 d-flex flex-column justify-content-between">
                            ...
                            <p className="lead mt-3 fs-3">
                                ...
                                adipisicing elit. Asperiores itaque nesciunt
                                suscipit alias architecto voluptates fuga
                                cupiditate, accusamus exercitationem, expedita
                                non perferendis error autem neque reiciendis,
                                minus iusto? Minima, natus.
                            </p>
                            <ul className="list-group d-flex justify-content-between mt-5">
                                ...
                                <li className="list-group-item d-block flex-column justify-content-between w-100 mt-3">
                                    ...
                                    <div>
                                        The {name} costs {cost_in_credits}{" "}
                                        credits. Its length is {length} meters,
                                        and it fits {crew} crew members and{" "}
